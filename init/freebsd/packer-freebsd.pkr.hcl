...
variable "iso_base_aa64" {
  type    = string
  default = "FreeBSD-13.2-RELEASE-arm64-aarch64"
}
...
source "qemu" "qemu_aarch64" {
  ...
  iso_url            = ""
  iso_urls           = ["file://${var.isos_pardir}/freebsd/${var.iso_base_aa64}-disc1.iso","https://${var.mirror_host}${var.iso_url_directory}/${var.iso_base_aa64}-disc1.iso"]
  machine_type       = "virt"
