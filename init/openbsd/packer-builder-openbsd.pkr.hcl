...
locals {
  ...
  iso_urls         = "aarch64" == var.MACHINE ? [
    "file://${var.isos_pardir}/openbsd/${var.iso_base_aa64}.img",
    "https://${var.mirror_host_aa64}${var.iso_url_directory_aa64}/${var.iso_base_aa64}.img"] : [
    "file://${var.isos_pardir}/openbsd/${var.iso_base_x64}.img",
    "https://${var.mirror_host_x64}${var.iso_url_directory_x64}/${var.iso_base_x64}.img"]
  #iso_checksum     = ("aarch64" == var.MACHINE ?
  #  "file:file://${var.isos_pardir}/openbsd/arm64/SHA256" :
  #  "file:file://${var.isos_pardir}/openbsd/amd64/SHA256")
  iso_checksum     = ("aarch64" == var.MACHINE ? "none" : "none")
  ...
  boot_command_x64_chroot  = ["<wait1m>", "S<enter><wait10>",
    ...
    "sh -x /tmp/disklabel_setup.sh mount_filesystems<enter><wait30s>",
