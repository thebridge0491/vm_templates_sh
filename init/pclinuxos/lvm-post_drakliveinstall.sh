...
pkgs_nms="basesystem bash apt rpm locales-en sudo dhcp-client man-pages nano dosfstools xfsprogs grub2 grub2-efi microcode_ctl efibootmgr lib64hal1 lvm2" # task-xfce"
