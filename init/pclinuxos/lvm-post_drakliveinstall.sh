...
pkgs_nms="basesystem bash apt rpm locales-en sudo dhcp-client man-pages nano dosfstools xfsprogs grub2 grub2-efi microcode_ctl efibootmgr lvm2" # task-xfce"
