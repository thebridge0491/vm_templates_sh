...
zypper --non-interactive install kernel-default makedev system-group-wheel sudo nano less dosfstools xfsprogs grub2 shim efibootmgr firewalld openssl openssh-askpass
