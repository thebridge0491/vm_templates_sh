OS_VARIANT=${OS_VARIANT:-generic} ; VM_NAME=${VM_NAME:-pclinuxos-Rolling-init}

INST_SRC_OPTS=${INST_SRC_OPTS:-"--cdrom=/mnt/Data0/distros/rolling/pclinuxos/pclinuxos64-KDE-2016.03.iso"}
...
##!!NOTE: edit boot entry: nokmsboot 3 text textmode=1 nomodeset
##!! login user/passwd: guest/- ; su


#apt-get update ; apt-get install -y lvm2 gdisk ; modprobe dm-mod ; vgchange -ay
