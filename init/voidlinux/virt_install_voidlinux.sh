OS_VARIANT=${OS_VARIANT:-generic} ; VM_NAME=${VM_NAME:-voidlinux-Rolling-init}

INST_SRC_OPTS=${INST_SRC_OPTS:-"--cdrom=/mnt/Data0/distros/rolling/voidlinux/void-live-x86_64-20160430.iso"}
...
##!! login user/passwd: root/voidlinux


#sv down sshd ; bash
#yes | xbps-install -S curl gptfdisk
