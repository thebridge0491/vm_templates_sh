...
source "qemu" "qemu_aarch64" {
  ...
  http_directory     = "init"
  iso_checksum       = "file:file://${var.isos_pardir}/opensuse/${var.isolive_name_aa64}.iso.sha256"
  iso_url            = ""
  iso_urls           = ["file://${var.isos_pardir}/opensuse/${var.isolive_name_aa64}.iso","${var.iso_url_mirror}/${var.isolive_url_directory}/${var.isolive_cdlabel_aa64}-aarch64-Media.iso"]
  machine_type       = "virt"
...
source "qemu" "qemu_x86_64" {
  ...
  headless           = "${var.headless}"
  http_directory     = "init"
  iso_checksum       = "file:file://${var.isos_pardir}/opensuse/${var.isolive_name_x64}.iso.sha256"
  iso_url            = ""
  iso_urls           = ["file://${var.isos_pardir}/opensuse/${var.isolive_name_x64}.iso","${var.iso_url_mirror}/${var.isolive_url_directory}/${var.isolive_cdlabel_x64}-x86_64-Media.iso"]
  machine_type       = "q35"
...
source "virtualbox-iso" "virtualbox_x86_64" {
  ...
  headless             = "${var.headless}"
  http_directory       = "init"
  iso_checksum         = "file:file://${var.isos_pardir}/opensuse/${var.iso_name_x64}.iso.sha256"
  iso_interface        = "sata"
  iso_url              = ""
  iso_urls             = ["file://${var.isos_pardir}/opensuse/${var.iso_name_x64}.iso","${var.iso_url_mirror}/${var.iso_url_directory}/${var.iso_name_x64}.iso"]
  output_directory     = "output-vms/${var.variant}-x86_64-${var.vol_mgr}"
  shutdown_command     = "sudo shutdown -hP +3 || sudo poweroff"
  ssh_password         = "${var.passwd_plain}"
  ssh_timeout          = "2h45m"
