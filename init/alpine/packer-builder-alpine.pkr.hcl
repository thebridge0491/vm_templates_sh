...
locals {
  ...
  iso_urls         = "aarch64" == var.MACHINE ? [
    "file://${var.isos_pardir}/alpine/${var.iso_base_aa64}.iso",
    "https://${var.mirror_host_aa64}${var.iso_url_directory_aa64}/${var.iso_base_aa64}.iso"] : [
    "file://${var.isos_pardir}/alpine/${var.iso_base_x64}.iso",
    "https://${var.mirror_host_x64}${var.iso_url_directory_x64}/${var.iso_base_x64}.iso"]
  iso_checksum     = ("aarch64" == var.MACHINE ?
    "file:file://${var.isos_pardir}/alpine/${var.iso_base_aa64}.iso.sha256" :
    "file:file://${var.isos_pardir}/alpine/${var.iso_base_x64}.iso.sha256")
